...
launchResult=subprocess.run(["python3", "launch_one_run.py", "./dataAll/dataAllUnitCell"+str(N)+"/T"+TStr+"/run_T"+TStr+".mc.conf"])
...
cpp_process = subprocess.Popen(
    [cppExecutable, "./dataAll/dataAllUnitCell"+str(N)+"/T"+TStr+"/cppIn.txt"],
...
stats_process=subprocess.Popen(["python3","-u", "check_after_one_run.py", "./dataAll/dataAllUnitCell"+str(N)+"/T"+TStr+"/run_T"+TStr+".mc.conf"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
while True:
